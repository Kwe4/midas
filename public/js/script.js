      ...
      var myChart = new Chart(myCanvas, {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: ['Income statistics', 'Nov - July'],
              align: 'start',
              color: '#171717',
              font: {
                size: 16,
...
// Triggers
const createTrans = document.getElementById('create-transaction')
const addStaff = document.getElementById('add-staff')
const addBrand = document.getElementById('add-brand')
const addUser = document.getElementById('add-user')

// Pop-Ups
const blur1 = document.getElementsByClassName('blur-container-1')[0]
const blur2 = document.getElementsByClassName('blur-container-2')[0]
const blur3 = document.getElementsByClassName('blur-container-3')[0]
const blur4 = document.getElementsByClassName('blur-container-4')[0]

// Closers
const closa1 = document.getElementsByClassName('closa-1')[0]
const closa2 = document.getElementsByClassName('closa-2')[0]
const closa3 = document.getElementsByClassName('closa-3')[0]
const closa4 = document.getElementsByClassName('closa-4')[0]


// Execute Showing
createTrans.addEventListener('click',()=>{
  blur1.classList.add('show')
})
addStaff.addEventListener('click',()=>{
  blur2.classList.add('show')
})
addBrand.addEventListener('click',()=>{
  blur3.classList.add('show')
})
addUser.addEventListener('click',()=>{
  blur4.classList.add('show')
})


// Execute Closing 

closa1.addEventListener('click',()=>{
  blur1.classList.remove('show')
})
closa2.addEventListener('click',()=>{
  blur2.classList.remove('show')
})
closa3.addEventListener('click',()=>{
  blur3.classList.remove('show')
})
closa4.addEventListener('click',()=>{
  blur4.classList.remove('show')
})